...
verifier('gestion.html sait se rendre intégré : classe html.integre, barre du haut cachée, « Retour équipe » caché', /integre/.test(gjs) && /html\.integre \.topbar\{[^}]*display:none/.test(css) && /html\.integre/.test(gestion));
