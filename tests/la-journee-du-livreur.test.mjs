...
const colis = [
  ...
  { id: 'f', statut: 'retour', created_at: '2026-09-04T10:00:00Z', retour_at: '2026-09-05T10:00:00Z' }, // retourné samedi, PAS ENCORE RENDU : toujours chez lui
  { id: 'h', statut: 'retour', created_at: '2026-09-04T10:00:00Z', retour_at: '2026-09-05T10:00:00Z', retour_rendu_at: '2026-09-06T10:00:00Z' }, // retourné samedi ET rendu dimanche : fini
...
titre('La journée de travail : ce qui est en route, plus ce qui a bougé ce jour-là');
{
  ...
  /* 17/09/2026, point 7.3 : un colis REVENU et pas encore rendu reste dans la journée du livreur
     — la marchandise est dans ses mains et il lui reste un geste à faire. Avant ce jour il
     disparaissait dès le lendemain, c'est-à-dire au moment précis où il commençait à traîner.
     Une fois rendu, il sort, comme un colis livré. */
...
titre("Chaque jour, son affichage (09/09/2026) : le jour d'un côté, les restes en route de l'autre");
{
  ...
  verifier('les restes = encore chez lui, reçus avant, sans geste ce jour-là : a, e, f (le retour non rendu)', ids(restes(colis, MARDI)) === 'aef', ids(restes(colis, MARDI)));
