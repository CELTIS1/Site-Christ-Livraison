...
verifier('seize fichiers numérotés dans app/equipe/, du 00 au 15 (15 : la chaîne de l\'argent, 10.1)', fichiersEquipe.length === 16 && fichiersEquipe.every((f, i) => f.startsWith(String(i).padStart(2, '0') + '-')), fichiersEquipe.join(', '));
