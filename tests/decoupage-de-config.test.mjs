...
verifier('quinze fichiers numérotés dans app/equipe/, du 00 au 14', fichiersEquipe.length === 15 && fichiersEquipe.every((f, i) => f.startsWith(String(i).padStart(2, '0') + '-')), fichiersEquipe.join(', '));
