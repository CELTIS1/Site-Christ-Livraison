...
verifier('quatorze fichiers numérotés dans app/equipe/, du 00 au 13', fichiersEquipe.length === 14 && fichiersEquipe.every((f, i) => f.startsWith(String(i).padStart(2, '0') + '-')), fichiersEquipe.join(', '));
