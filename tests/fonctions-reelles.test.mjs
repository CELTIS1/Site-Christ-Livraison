...
verifier('toute commune d\'Abidjan vers le Plateau : 1 500 F (Songon : 2 500, Grand-Bassam : 3 000)', app.COMMUNES.filter(c => c !== 'Grand-Bassam' && c !== 'Songon').every(c => app.computePrixLivraison(c, 'Plateau') === 1500) && app.computePrixLivraison('Songon', 'Plateau') === 2500);
...
verifier('Adjamé → Marcory et Adjamé → Treichville : 1 500 F (Celtis, 16/09 soir) ; Abobo → Marcory reste 2 000 F', app.computePrixLivraison('Adjamé', 'Marcory') === 1500 && app.computePrixLivraison('Adjamé', 'Treichville') === 1500 && app.computePrixLivraison('Abobo', 'Marcory') === 2000);
verifier('Attécoubé, 13ᵉ commune : dans la liste, 1 500 F vers Adjamé, Plateau, Yopougon, Cocody ; 2 000 F Abobo ; 2 500 F Port-Bouët', app.COMMUNES.includes('Attécoubé') && app.COMMUNES.length === 14 && ['Adjamé', 'Plateau', 'Yopougon', 'Cocody'].every(c => app.computePrixLivraison('Attécoubé', c) === 1500) && app.computePrixLivraison('Attécoubé', 'Abobo') === 2000 && app.computePrixLivraison('Attécoubé', 'Port-Bouët') === 2500);
verifier('Songon, 14ᵉ commune (Celtis, 20/09/2026) : 2 000 F depuis Yopougon, 2 500 F depuis Attécoubé, Adjamé, Plateau, 3 000 F ailleurs — jamais au-delà', app.COMMUNES.includes('Songon') && app.computePrixLivraison('Yopougon', 'Songon') === 2000 && ['Attécoubé', 'Adjamé', 'Plateau'].every(c => app.computePrixLivraison(c, 'Songon') === 2500) && ['Abobo', 'Cocody', 'Koumassi', 'Port-Bouët', 'Anyama', 'Bingerville', 'Grand-Bassam'].every(c => app.computePrixLivraison(c, 'Songon') === 3000) && app.computePrixLivraison('Songon', 'Songon') === 1500);
