...
verifier('Attécoubé, 13ᵉ commune : dans la liste, 1 500 F vers Adjamé, Plateau, Yopougon, Cocody ; 2 000 F Abobo ; 2 500 F Port-Bouët', app.COMMUNES.includes('Attécoubé') && app.COMMUNES.length === 13 && ['Adjamé', 'Plateau', 'Yopougon', 'Cocody'].every(c => app.computePrixLivraison('Attécoubé', c) === 1500) && app.computePrixLivraison('Attécoubé', 'Abobo') === 2000 && app.computePrixLivraison('Attécoubé', 'Port-Bouët') === 2500);
