...
verifier('huit fiches du client (commander, adresses, suivre, annuler, payer, signaler, code, conditions) — aucune du coursier', ex.ids.filter((i) => /^aide-express-/.test(i)).length === 8 && !ex.ids.some((i) => /^aide-coursier-/.test(i)), ex.ids.join(','));
await page.emulateMedia({ colorScheme: 'light' });
