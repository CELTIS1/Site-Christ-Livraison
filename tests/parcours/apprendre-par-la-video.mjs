...
verifier('seules les fiches qui ont une vidéo restent, toutes dépliées (4 chez le livreur)', nbOuvertes === 4 && (await ouvertes.evaluateAll(l => l.every(d => d.open && d.querySelector('video')))), String(nbOuvertes));
