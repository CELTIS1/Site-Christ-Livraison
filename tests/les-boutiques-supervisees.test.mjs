...
verifier('« Boutiques » n\'est pas un écran d\'ouverture mémorisé (l\'onglet n\'existe qu\'après lecture)', /\['section-accueil','section-ajouter','section-recap','section-colis','section-retours'\]\.includes\(cur\)/.test(f));
