...
verifier('même règle de jour que partout (jourDuColis), même découpage que les tuiles d\'une cliente', /jourDuColis\(c\) === mbJour/.test(f) && /compterLeJour\(selection, 'cliente'\)/.test(f) && /mbRegles = \(\) => \(\{ compterLeJour, totauxArgent,/.test(f));
