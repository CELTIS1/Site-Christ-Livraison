...
verifier('la preuve en chiffres : quatre tuiles, lues par site_chiffres_mois (fonction publique, distincte de site_chiffres du 16/09), une seule chargerChiffres, tirets sans réseau', ['chiffre-livres-mois', 'chiffre-taux', 'chiffre-vendeuses', 'chiffre-reverse'].every(id => new RegExp('id="' + id + '">—<').test(index)) && /rest\/v1\/rpc\/site_chiffres_mois/.test(index) && /chargerChiffresDuMois\(\);/.test(index) && (index.match(/function chargerChiffres\(\)/g) || []).length === 1 && /les tirets restent/.test(index));
