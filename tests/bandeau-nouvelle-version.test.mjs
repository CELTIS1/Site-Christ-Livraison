...
/* Ce numéro est écrit en dur EXPRÈS. Il n'a pas pour but de vérifier une règle, mais d'obliger
   ...
   (le repère de défilement était la fiche épinglée) ; bouton « Aller en bas ». (5) Cliente ›
   Récap : « Mon relevé » replié d'office, sous le récapitulatif ; la tuile « Total colis » n'est
   plus blanche sur blanc. Bancs étendus, parcours 25. Étiquette 20260921bas.
   v213, le 21/09/2026 — retours de Celtis, six sujets. (1) En base, pas dans le site : la cliente
   ne pouvait plus confirmer un retour (le garde-fou colis_garde_champs_client refusait l'écriture
   de cliente_repond_au_retour) — migration 2026-09-21-la-cliente-peut-repondre-au-retour.sql,
   appliquée et essayée en production. (2) Tournées : un départ ne vaut que pour SA journée
   ...
   (le repère de défilement était la fiche épinglée) ; bouton « Aller en bas ». (5) Cliente ›
   Récap : « Mon relevé » replié d'office, sous le récapitulatif ; la tuile « Total colis » n'est
   plus blanche sur blanc. Bancs étendus, parcours 25. Étiquette 20260921voir.
   v213, le 21/09/2026 — retours de Celtis, six sujets. (1) En base, pas dans le site : la cliente
   ne pouvait plus confirmer un retour (le garde-fou colis_garde_champs_client refusait l'écriture
   de cliente_repond_au_retour) — migration 2026-09-21-la-cliente-peut-repondre-au-retour.sql,
   appliquée et essayée en production. (2) Tournées : un départ ne vaut que pour SA journée
   ...
   (le repère de défilement était la fiche épinglée) ; bouton « Aller en bas ». (5) Cliente ›
   Récap : « Mon relevé » replié d'office, sous le récapitulatif ; la tuile « Total colis » n'est
   plus blanche sur blanc. Bancs étendus, parcours 25. Étiquette 20260921tout.
   v213, le 21/09/2026 — retours de Celtis, six sujets. (1) En base, pas dans le site : la cliente
   ne pouvait plus confirmer un retour (le garde-fou colis_garde_champs_client refusait l'écriture
   de cliente_repond_au_retour) — migration 2026-09-21-la-cliente-peut-repondre-au-retour.sql,
   appliquée et essayée en production. (2) Tournées : un départ ne vaut que pour SA journée
   ...
   (le repère de défilement était la fiche épinglée) ; bouton « Aller en bas ». (5) Cliente ›
   Récap : « Mon relevé » replié d'office, sous le récapitulatif ; la tuile « Total colis » n'est
   plus blanche sur blanc. Bancs étendus, parcours 25. Étiquette 20260921modifier.
   v213, le 21/09/2026 — retours de Celtis, six sujets. (1) En base, pas dans le site : la cliente
   ne pouvait plus confirmer un retour (le garde-fou colis_garde_champs_client refusait l'écriture
   de cliente_repond_au_retour) — migration 2026-09-21-la-cliente-peut-repondre-au-retour.sql,
   appliquée et essayée en production. (2) Tournées : un départ ne vaut que pour SA journée
   ...
   (le repère de défilement était la fiche épinglée) ; bouton « Aller en bas ». (5) Cliente ›
   Récap : « Mon relevé » replié d'office, sous le récapitulatif ; la tuile « Total colis » n'est
   plus blanche sur blanc. Bancs étendus, parcours 25. Étiquette 20260921numeros2.
   v213, le 21/09/2026 — retours de Celtis, six sujets. (1) En base, pas dans le site : la cliente
   ne pouvait plus confirmer un retour (le garde-fou colis_garde_champs_client refusait l'écriture
   de cliente_repond_au_retour) — migration 2026-09-21-la-cliente-peut-repondre-au-retour.sql,
   appliquée et essayée en production. (2) Tournées : un départ ne vaut que pour SA journée
   ...
   (le repère de défilement était la fiche épinglée) ; bouton « Aller en bas ». (5) Cliente ›
   Récap : « Mon relevé » replié d'office, sous le récapitulatif ; la tuile « Total colis » n'est
   plus blanche sur blanc. Bancs étendus, parcours 25. Étiquette 20260921google.
   v213, le 21/09/2026 — retours de Celtis, six sujets. (1) En base, pas dans le site : la cliente
   ne pouvait plus confirmer un retour (le garde-fou colis_garde_champs_client refusait l'écriture
   de cliente_repond_au_retour) — migration 2026-09-21-la-cliente-peut-repondre-au-retour.sql,
   appliquée et essayée en production. (2) Tournées : un départ ne vaut que pour SA journée
...
v236 — 23 septembre 2026 — La barre du bas, fixée en bas
   ...
   v276, le 26/09/2026 — Site, téléphone : « Demander un devis » et « Se connecter » en tête du tiroir ☰ (la barre fixe du bas les cachait), tiroir arrêté au-dessus de la barre ; Équipe › Bureau › « Plein écran » ouvre Gestion dans le même onglet (dans l'application installée, le nouvel onglet partait dans Safari sans la session) ; registre des fonctions : envoyer-push redéployée le 26/09. Étiquette 20260926tiroir.
   v277, le 26/09/2026 — L'assistant qui comprend (étage 3) : fonction serveur assistant-repondre (Claude Haiku, consigne CLT, situation de la personne + fiches proches, plafond mensuel et par personne, journal assistant_echanges — SQL 2026-09-26-l-assistant-qui-comprend.sql ; clé ANTHROPIC_API_KEY à poser par Celtis, sinon repli silencieux) ; S-5 : l'assistant du site pour les visiteurs (site-assistant.js, réponses écrites, WhatsApp) sur l'accueil, Vendeuses, Livreurs, Express ; la vendeuse de la semaine sur l'accueil (site_vendeuses, une par semaine ISO). Étiquette 20260926comprend.
   v278, le 26/09/2026 — L'amélioration constante (chantier R) : usage_mesures() (SQL 2026-09-26-l-amelioration-constante.sql), rapports_usage + fonction serveur rapport-usage (l'IA rédige : bien / mal / jamais utilisé, à éviter, 3 propositions), poussés le lundi 6 h (rappel) et le 1er du mois (bilan) dans Gestion › Rapports reçus (« Lire l'analyse », boutons « maintenant ») ; vidéo « Où trouver l'aide et les vidéos » (livreurs, première fiche, copie WhatsApp). Étiquette 20260926constante.
   v279, le 26/09/2026 — Gestion : les cartes du tableau de bord se replient (chevron, mémoire, « Tout déplier / Tout replier » ; ouvertes par défaut : dix chiffres, rapports reçus, À faire), la barre latérale n'ouvre que l'onglet courant (chevrons Comptabilité, Paie…), un champ « Chercher un écran » (barre ≥ 1 200 px, au-dessus des onglets sur téléphone) ; gestion-replier.js. Étiquette 20260926gestion.
   v280, le 26/09/2026 — Gestion › Rapports reçus : « Confier à Claude » sous chaque analyse d'usage (copie le rapport entier + consigne, ouvre claude.ai/new ; repli execCommand, toast) ; texteVersClaude(). Étiquette 20260926confier.
   v281, le 26/09/2026 — Lot T « Dossier confiance » : le dossier du livreur. Douze pièces par livreur (app/dossier-du-livreur.js : états à jour / bientôt 30 j / périmée / manquante / sans objet, échéance saisie ou calculée, badge « Certifié CLT ») ; Gestion › Paie › Dossiers (liste + fiche, upsert livreurs_dossier, fichier relié au coffre) et carte « Dossiers des livreurs » du tableau de bord ; livreur : ☰ › Mon dossier CLT (mon_dossier_livreur(), lecture seule). SQL 2026-09-26-le-dossier-du-livreur.sql joué en base. Étiquette 20260926dossier.
   v282, le 26/09/2026 — Lot U « La porte des partenaires » (Générale CI) : partenaire_recevoir_commande / partenaire_suivi en base (clé par empreinte sha256, tarif partenaire 1 000 F même commune sinon grille, une référence = un colis), colis.partenaire_id + reference_partenaire ; marque « 🤝 Partenaire · réf. » sur toutes les cartes (colisDestinationHTML) ; Gestion › Comptabilité › Partenaires (compte relié, clé montrée une fois, compteurs, adresses) ; app/partenaires.js + partenaires-ecran.js. SQL 2026-09-26-la-porte-des-partenaires.sql joué en base. Étiquette 20260926partenaires.
   v283, le 26/09/2026 — Lot V « Qui a soldé quoi » : colis.trace_soldes (déclencheur colis_trace_soldes : qui, rôle, quand, à la saisie ou après ; journal colis_solde_modifie ; l'existant « avant_suivi ») ; lib/argent.js soldesDuColis / soldeTexte / soldesResume / soldesColisHTML / soldesResumeHTML ; point du livreur (écran : ligne 🔖 sous le colis + encadré sous le TOTAL ; PDF : colonne Observation + phrase), relevé de la cliente (observation), cartes de la cliente et de l'équipe. SQL 2026-09-26-qui-a-solde.sql joué en base. Étiquette 20260926soldes.
   v284, le 26/09/2026 — Lot AV « Les avis » : table avis_colis + avis_lire/avis_donner (numéro + 4 chiffres, colis livré, 30 jours), avis_bureau, avis_publier (admin + accord), site_avis (moyenne de tous les avis) ; app/avis.js (règles) et app/avis-ecran.js (Gestion › Site › Avis) ; suivi.html : photos en vignettes + visionneuse, lignes resserrées, contacts repliés une fois livré, bloc « Votre avis compte » hors de la zone actualisée ; index.html : témoignages vedettes en tête (2 colonnes / glissés sur téléphone), note moyenne dès 5 avis et avis publiés sur 2 lignes ; message « livré » avec lien ?avis=1. SQL 2026-09-26-les-avis.sql joué en base. Étiquette 20260926avis.
   v285, le 26/09/2026 — Le site, chiffres revus : colis et fournisseurs arrondis, lus au même endroit (site_chiffres, data-chiffre) dans le bandeau et « À propos », même libellé ; le taux du mois seul lu par site_chiffres_mois ; le montant reversé n'est plus affiché ; bandeau en trois tuiles (320 px sans coupure) ; « vendeuses » devient « fournisseurs » (bandeau, À propos, fournisseur de la semaine, menu et pied de page ; page vendeuses.html inchangée) ; content.json et fiche site_contenu alignés. Étiquette 20260926chiffres.
   v286, le 26/09/2026 — « Vendeuse » devient « fournisseur » partout où on le lit : site (accueil, page Fournisseurs, tarifs, contact, conditions générales, livreurs), application (livreur : « J'ai prévenu le fournisseur », primes ; équipe ; gestion ; aide et guide), tutoriel, consignes des assistants IA (à redéployer). Accords revus ligne par ligne ; les noms techniques (vendeuse_prevenue, vendeuses.html, site_vendeuses, valeur « vendeuse » des réclamations) inchangés. Étiquette 20260926fournisseurs.
   v287, le 26/09/2026 — L'accueil qui inspire confiance et invite : bandeau sans nombre de colis (la base ne compte que depuis le 18/08) — le nombre EXACT de vendeurs et d'entreprises servis ce mois, le taux du premier coup, 100 % des colis suivis en ligne ; « À propos » : 60+ vendeurs et entreprises (total arrondi), 14 communes, 1 000 FCFA ; deux appels à l'action ajoutés (sous « Comment ça marche », et « Confiez-nous vos colis » après les avis : vendeur / entreprise, comptés) ; vocabulaire « vendeurs » (hommes et femmes) au lieu de « fournisseurs », témoignages avec leur vrai libellé ; assistant redéployé. Étiquette 20260926accueil.
   v288, le 26/09/2026 — Le site qui bouge (référence github.com) : site-mouvement.js — chiffres qui comptent à l'arrivée de leur section (bandeau, « Qui sommes-nous », note des avis), cartes en cascade, trait des titres qui se dessine, images qui s'approchent, pulsation des chiffres ; vidéos qui se jouent seules à l'écran (sans son, en boucle ; rien en économiseur de données ni en 2G) ; menu déroulant façon GitHub (icône + titre + une ligne, animé, pont invisible et 300 ms d'attente : il ne disparaît plus quand on descend lentement) ; les pages Vendeurs, Livreurs, Services, Tarifs, Express et Contact reçoivent les mêmes apparitions. « Réduire les animations » respecté. Étiquette 20260926mouvement.
   v289, le 26/09/2026 — Lot CA « Le carburant des livreurs » (Gestion seulement) : carburant_reglages (plafond par livreur : KTM X1 3 000 F, moto plus grosse 4 000 F, ou un autre montant), carburant_pleins (un plein par jour, annulation avec motif, rien ne s'efface), carburant_colis_livres() ; app/carburant.js (règles) et app/carburant-ecran.js (Gestion › Paie › ⛽ Carburant : le jour, les alertes 2 pleins / dépassement / plein sans colis, le mois et le coût par colis). site_chiffres : les 14 communes desservies (grille) — « Expédition (intérieur) » était comptée. SQL 2026-09-26-le-carburant.sql joué en base. Étiquette 20260926carburant.
   v290, le 26/09/2026 — Lot RA « Les raccourcis du gérant » : le bouton « Plus » (téléphone) et « ⊞ Raccourcis » (ordinateur) ouvrent quatre colonnes colorées — Aujourd'hui (à faire du gérant, à traiter, à confier, carburant du jour, avis, dossiers, avec les nombres en direct), Argent, Équipe et vendeurs, Site et plus ; chaque case mène au bon écran, y compris une page précise de Gestion dans l'onglet Bureau (gestion.js : cltAller, ?aller= et message). app/raccourcis.js (règles), app/equipe/20-raccourcis.js (écran). Site : liens Instagram et TikTok rétablis (@christlivraison, les anciens comptes n'existent plus), « Nos services » du pied de page devenus des liens, pied de page dégagé des boutons flottants sur téléphone. Étiquette 20260926raccourcis.
   v291, le 26/09/2026 — Lot OB « Le compte observateur » : profiles.observateur (seul l'administrateur le pose ou le retire, date et auteur posés par la base) ; verrou « lecture seule » DANS LA BASE — déclencheur avant écriture sur chaque table (même les fonctions de la base passent par lui), posé tout seul sur toute nouvelle table (déclencheur d'événement), fichiers bloqués (politiques restrictives du stockage), observateur_tables_sans_verrou() pour vérifier ; creer-client, creer-livreur et approuver-reset-password refusent un observateur (redéployées). Écran : app/observateur.js (règles), cltModeObservateur (clt-common.js : écritures refusées avant de partir, bandeau), Équipe › Comptes : « 👁 Passer en observateur » / « ✋ Donner le droit d'agir », confirmé et tracé ; création d'un compte équipe : « Commencer en observateur » coché par défaut. SQL 2026-09-26-le-compte-observateur.sql joué et testé en base. Étiquette 20260926observateur.
   v292, le 26/09/2026 — Lot AC « L'accueil du Bureau » (1er des accueils par espace) : nouvel onglet « 🏠 Accueil » en tête (haut et bas), premier écran au premier lancement du jour ou après 30 minutes de pause, sinon on retrouve son écran ; une notification ou un lien précis passe avant ; revenue au premier plan après une pause : l'Accueil. « Bonjour » + la phrase du jour, les quatre chiffres du jour, quatre colonnes — Colis (créer, à confier, tous les colis, tournées, suivi), Les points du jour (livreurs, vendeurs, à traiter, ce qui manque), Argent (rapports, comptabilité, carburant, primes), Équipe et comptes — chaque case avec son nombre et menant à son écran (onglet, vue de l'Argent, page de Gestion). app/accueil.js (règles, communes à tous les espaces), app/equipe/21-accueil.js ; les chiffres viennent de L'essentiel (rien de relu). Le « retour » du téléphone referme aussi les raccourcis. Correction : « CLT Express — Coursiers » s'affichait sous tous les onglets. Étiquette 20260926accueil.
   v293, le 26/09/2026 — Lot AC « L'accueil du livreur » : onglet « 🏠 Accueil » en tête (haut et bas ; « Mes colis » prend l'icône du colis, « Récup. » celle des flèches), ouvert au premier lancement du jour ou après 30 minutes de pause (même règle que le Bureau, retour au premier plan compris), sinon il retrouve son écran ; une notification passe avant. « Bonjour Koffi », la phrase du jour, quatre chiffres (à livrer, livrés, non livrés, en main), trois colonnes — Ma journée (colis du jour — seulement ceux du jour —, colis d'avant, récupérations, à rendre), Mon argent (en main, mon point du jour, mon mois), Moi et CLT (mon dossier, signaler, appeler). Tout se lit dans les colis du téléphone : marche sans réseau. La carte « Ma journée » du haut s'efface sur l'Accueil. app/livreur-accueil.js ; le dessin des cases passe dans style.css, commun à tous les espaces. Étiquette 20260926livreur.
   v294, le 26/09/2026 — Lot AC « L'accueil de la cliente et du propriétaire » : onglet « 🏠 Accueil » en tête (haut et bas), même règle d'ouverture que les autres espaces. « Bonjour », la phrase du jour, quatre chiffres (confiés aujourd'hui, livrés, en route, CLT me doit), trois colonnes — Mes colis (« Faire passer un livreur — Nous venons chercher vos colis : dites-nous quel jour », avec l'état de la demande ; ajouter ; mes colis d'aujourd'hui ; suivre un colis), Mon argent (ce que CLT me doit, mon point du jour, mon mois), Retours et aide (mes retours, écrire, appeler) ; le propriétaire a en plus « Mes boutiques », une case par boutique avec ses colis du jour, qui ouvre cette boutique. Rien n'est relu dans la base. Les six onglets du haut d'un propriétaire se resserrent pour tenir. app/fournisseur-accueil.js. Étiquette 20260926vendeurs.
   v295, le 26/09/2026 — Lot AC « L'accueil de CLT Express » (dernier des accueils) : comme Uber, Yango et Uber Driver, le premier écran reste le geste principal (commander ; être disponible) et la synthèse se pose en tête. Client : « Bonjour Yao », la phrase (« Où livrons-nous aujourd'hui ? » ou l'état de sa course : « un coursier arrive »…), Ma course en cours (mène à sa carte), Mes courses, Mon compte ; le formulaire reste dessous. Coursier : en tête de « Dispo », au-dessus de « Je suis disponible » : sa course (« À récupérer », « À livrer »), son solde (« à recharger » sous le minimum), son compte. Rien n'est relu dans la base (la synthèse suit la page). app/express-accueil.js ; règles dans accueil.js. Étiquette 20260926express.
   v296, le 26/09/2026 — La fiche du colis ne bouge plus (Équipe, grand écran) : elle était posée en position fixe à des coordonnées recalculées à chaque défilement ; au changement d'onglet la liste mesurait zéro et la fiche partait à gauche. Désormais, comme goafricaonline (étudié le 26/09) : deux colonnes en grille, la fiche collante (position:sticky) dans la sienne, tenue par le navigateur ; les groupes jour et cliente passent en « display:contents » pour que la fiche couvre toute la hauteur de la liste. Mesuré : même place en défilant, même place après un aller-retour d'onglets, collée sous la barre d'onglets. Étiquette 20260926fiche.
   v297, le 26/09/2026 — Le site, refait comme celui d'une entreprise installée (inspiré de Licy Express et de Yango, sans rien casser de ce qui marchait) : « depuis 2023 » partout (titre, À propos, données pour Google) ; trois sections nouvelles, remplies depuis Gestion › Site : Notre équipe, Actualités et événements, Nos partenaires (appel « Devenir partenaire » tant qu'aucun accord n'est signé) ; menu « À propos » complété ; pied de page refait (L'entreprise, Pour vous, Nos services, Contact ; © 2023–2026 ; « Site et application conçus par Celtis Labs » sur toutes les pages). Discrétion : plus de vidéos de l'application (accueil, Vendeurs, Livreurs, Express), plus de grille de prix publiée (Tarifs : prix de départ et principes, la grille est remise avec le devis ; Express : prix selon la distance, affiché avant) — « Demander une démonstration » à la place. Étiquette 20260926site. */
verifier(
  'la version du cache a été incrémentée avec ce changement',
  /CACHE_VERSION = 'clt-shell-v297'/.test(sw),
