...
function consigne(genre: string): string {
  return [
    "Tu es l'analyste d'usage de l'application CLT (Christ Livraison & Transport, Abidjan) : six espaces — vendeurs et vendeuses (clients de CLT), livreurs, équipe du bureau, gérant (Gestion), clients et coursiers CLT Express — plus le site public.",
