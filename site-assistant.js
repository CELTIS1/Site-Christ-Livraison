...
(function () {
  ...
  var REPONSES = [
    ...
    { id: 'vendeuse', poids: 1, mots: ['vendeur', 'vendeurs', 'fournisseur', 'vendeuse', 'vendeuses', 'vendre', 'vends', 'payee', 'paye', 'boutique', 'commercante', 'commercant', 'client', 'cliente', 'devenir cliente', 'reversement', 'reverse', 'argent', 'encaisse'], texte: 'Vous vendez, on livre et on encaisse pour vous : l\'argent vous revient avec un reçu numéroté, et vous voyez chaque colis en direct. La première livraison est offerte.', lien: 'vendeuses.html', libelle: 'La page Vendeuses' },
