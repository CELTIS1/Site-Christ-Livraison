...
(function () {
  ...
  var REPONSES = [
    ...
    { id: 'vendeuse', poids: 1, mots: ['vendeuse', 'vendeuses', 'vendre', 'vends', 'payee', 'paye', 'boutique', 'commercante', 'commercant', 'client', 'cliente', 'devenir cliente', 'reversement', 'reverse', 'argent', 'encaisse'], texte: 'Vous vendez, on livre et on encaisse pour vous : l\'argent vous revient avec un reçu numéroté, et vous voyez chaque colis en direct. La première livraison est offerte.', lien: 'vendeuses.html', libelle: 'La page Vendeuses' },
  ...
  var SUGGESTIONS = { 'index': ['Combien ça coûte ?', 'Comment ça marche ?', 'Vous livrez où ?'], 'vendeuses': ['Comment je suis payée ?', 'Comment ça marche ?', 'Et si un colis se perd ?'], 'livreurs': ['Combien gagne un livreur ?', 'Comment postuler ?', 'Faut-il sa moto ?'], 'express': ['Comment marche Express ?', 'Combien ça coûte ?', 'Le code à 4 chiffres ?'] };
