...
(function () {
  ...
  function barreHTML(a) {
    ...
    return `<div class="card reg-barre">`
      ...
      + `<label class="reg-motif-champ">Motif (obligatoire)<input type="text" id="reg-motif" maxlength="300" autocomplete="off" placeholder="Ex. : rendus à la vendeuse en août, avant la mise en service" value="${ech(m)}"></label>`
      + `</div>`
