...
<div class="pdj">
  ...
  <div class="pdj-deux">
    <div class="pdj-bloc pdj-clientes">
      ...
      <div class="pdj-tuiles">
        ${tuile('Devait rentrer', F(a.attendu), { title: 'Articles des colis livrés et non livrés du jour, hors articles soldés chez le vendeur' })}
      ...
      ${a.soldes ? `<div class="pdj-note">+ ${F(a.soldes)} d'articles soldés chez le vendeur (${a.nbSoldes} colis) : pas d'argent à la porte, rien à reverser.</div>` : ''}
    </div>
